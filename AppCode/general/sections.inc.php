...
class phpSections{
    ...
    // * Métodos Públicos
    // *****************************************************************************
    function SectionUnderConstruction($objTraductor, $objUrlAmigable){
      
      $Section = "";

        $Section .= "<section id=\"error\" class=\"container text-center\">";
          $Section .= "<h1>Página no disponible</h1>";
          $Section .= "<p>Estamos trabajando en la mejora de nuestra web para ofrecerle un servicio aún más completo.</p>";
          $Section .= "<p>Disculpe las molestias y gracias por visitar nuestra web.</p>";          
          $Section .= "<a class=\"btn btn-primary\" href=\"" . $objUrlAmigable->Amigable(null) . "\">VUELVA A LA PÁGINA DE INCIO</a>";
        $Section .= "</section><!--/#error-->";

        return $Section;
    } 
    
    function SectionError($objTraductor, $objUrlAmigable){
    ...
    function SectionPrincipalHome($objParametros, $objTraductor, $objUrlAmigable)
    {
        $Section = "";
        ...
        $Section .= "<div class=\"container\" id=\"containerPrincipalHome\">";
            $Section .= "<div class=\"row\">";
                ...
                $Section .= "<div class=\"col-sm-3 col-xs-12\" id=\"columnaDerecha\">";
                    $Section .= $this->SectionPrincipalHomeBanner($objParametros, $objTraductor, $objUrlAmigable);
                $Section .= "</div>";
    ...
    function SectionPrincipalHomeComment($objParametros, $objTraductor)
    {
        ...
        $Section .= "<section id=\"usuariosOpiniones\">";
            $Section .= "<div class=\"container\">";
                ...
                $Section .= "<div class=\"col-xs-12 col-sm-12 wow fadeInDown animated animated\" style=\"visibility: visible; animation-name: fadeInDown;\">";
                $Section .= "<div class=\"testimonial\">";
                $Section .= "<h2>Las últimas opiniones de nuestros usuarios</h2>";
    ...
    function SectionPrincipalHomeBanner($objParametros, $objTraductor, $objUrlAmigable)
    {
        $Section = "";

        $Section .= "<ul class=\"banners\">";
            $Section .= "<li> <a href=\"". $objUrlAmigable->Amigable("destinos.php") . "\" title=\"\"><img src=\"" . $objParametros->Directorio . "/images/banner1.png\" alt=\"\"/></a></li>";
            $Section .= "<li> <a href=\"". $objUrlAmigable->Amigable("puertos.php") . "\" title=\"\"><img src=\"" . $objParametros->Directorio . "/images/banner2.png\" alt=\"\"/></a></li>";
        ...
        /*          
        $Section .= "<div class=\"seccionRRSS\">";
            $Section .= "<h2 class=\"homepage_tips\">Síguenos</h2>";
            $Section .= "<div class=\"logolink\">";
                $Section .= "<a href=\"\" target=\"_blank\" class=\"followImgLnk\">";
                    $Section .= "<i class=\"fa fa-facebook\"></i>";
                $Section .= "</a>";
                $Section .= "<a href=\"\" target=\"_blank\">";
                    $Section .= "&nbsp;Síguenos en Facebook";
                $Section .= "</a>";
            $Section .= "</div>";
            $Section .= "<div class=\"logolink\">";
                $Section .= "<a href=\"\" target=\"_blank\" class=\"followImgLnk\">";
                $Section .= "<i class=\"fa fa-twitter\"></i>";
                $Section .= "</a>";
                $Section .= "<a href=\"\" target=\"_blank\">";
                $Section .= "&nbsp;Síguenos en Twitter";
                $Section .= "</a>";
            $Section .= "</div>";
        $Section .= "</div>";
        */
    ...
    function SectionOpinion($objTraductor, $objParametros, $intBuque, $objUsuario){
        ...
        $objFormulario->Metodo = "post";
        $objFormulario->Accion = $objParametros->Directorio . "/control.php?Accion=comment-form";
       ...
       if ($objUsuario->Conectado()){
            ...
            $Section .= "<p><a data-target=\"#loginForm\" data-toggle=\"modal\" class=\"botonNaranja\" title=\"registrese o inicie sesión en el sistema\">registrese o inicie sesión en el sistema.</a></p>";
            $Section .= "</div>";
            $Section .= "</div>";
    ...
    function SectionOpinar($objParametros, $objTraductor, $objUrlAmigable)
    {
        ...
        $Section .= "<div class=\"row\">";
            ...
            $objParticipacion = new phpParticipacion();
            $objParticipacion->Consulta(5);
            $Section .= "<h1>Las últimas opiniones de nuestros usuarios</h1>";
            ...
            $Section .= "<!--center-->";
            $Section .= "<div class=\"col-md-4\">";
            $Section .= "<h1>Los barcos mejor valorados</h1>";
            $objBuque = new phpBuque();
            $objBuque->ConsultaValorados(5);
            if ($objBuque->Datos->NumeroElementos() > 0)
            {
            ...
            $Section .= "<!--right-->";
            $Section .= "<div class=\"col-md-4\">";
                $Section .= "<h1>Imágenes de nuestros usuarios</h1>";
    ...
    function SectionOpinionesUsuario($objParametros, $objTraductor, $Codigo)
    {
        ...
        $Section .= "<div class=\"row\">";
            ...
            $Section .= "<h1>Opiniones de nuestro usuario</h1>";
