...
class phpBuque{
    ...
    public $DescripcionCortaRecortada;
    ...
    Public function Inicia(){
        ...
        $this->DescripcionCortaRecortada = null;
    ...
    public function UrlOpiniones()

    {

        return "buque.php?id=" . $this->getCodigo() . "&cod=" . vbPaginaCruceros . "&nav=3&nom=" . $this->Nombre;
        ...
        $html .= "<div class=\"col-sm-6 col-md-4\">";
            ...
            $html .= "<div class=\"media services-wrap wow fadeInDown animated\" style=\"visibility: visible; animation-name: fadeInDown;\">";
                ...
                $html .= "<div class=\"media-body\">";
                    ...
                    $html .= "<p>" . $this->DibujaIconoOpinar() . $this->DescripcionCortaRecortada . "</p>";  
    ...
    public function DibujaIconoOpinar()

    {

        $html = "";

        $html .= " <a style=\"margin-right:10px;\"  title=\"Opinar\" href=\"" . $this->UrlAmigableOpiniones() . "\"><i class=\"fa fa-2x fa-comment\"></i>&nbsp;</a>";        
    ...
    public function DibujaBotonOpinar()

    {

        $html = "";

        $html .= " <a style=\"margin-right:10px;\"  class=\"btn btn-primary buttonNaranja\" title=\"Opinar\" href=\"" . $this->UrlAmigableOpiniones() . "\">Opinar</a>";        
...

    {
...

        {
            ...
            if ((!is_null($this->DescripcionCorta))&&($this->DescripcionCorta!="")) {
                ...
                $this->DescripcionCortaRecortada = $this->recortar_texto($this->DescripcionCorta, 180, '...');
